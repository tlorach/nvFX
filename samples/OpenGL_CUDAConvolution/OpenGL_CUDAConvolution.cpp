...
#define SCENE_EFFECT "OpenGL_CUDAConvolution.glslfx"
#define NMODELS 2
#define MODEL1 "gargoyle_anim_tris_noteeth_v133.bk3d.gz"
#define MODEL2 "Buggy_PN_v133.bk3d.gz"
    ...
    switch( key )
    {
        ...
        case '5':
            if(fx_TechMaterial = fx_EffectMaterial->findTechnique(TECH_DEFAULT+key-'4'))
            {
                ...
                #ifdef USESVCUI
                g_pComboTechMat->SetSelectedByIndex(key-'4');
                #endif
        ...
        case '7':
            ...
            #ifdef USESVCUI
            g_pComboMesh->SetSelectedByIndex(g_curMesh);
            #endif
            break;
        case 'm':
...
#ifdef USESVCUI
        g_pComboTech->AddItem(fx_TechScene->getName(), t);
#endif
    }
#ifdef USESVCUI
...
#ifdef USESVCUI
    g_pComboTechMat->RemoveAllItems();
#endif
...
#ifdef USESVCUI
        g_pComboTechMat->AddItem(fx_TechMaterial->getName(), t);
#endif
    }
#ifdef USESVCUI
    g_pComboTechMat->SetSelectedByIndex(0);
#endif
