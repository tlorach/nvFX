...
template<class T>
quaternion<T> & hproduct(quaternion<T>& p, const quaternion<T>& q1, const quaternion<T>& q2)
{
    quaternion<T> t1, t2;
    p.w = q1.w*q2.w-q1.x*q2.x-q1.y*q2.z-q1.z*q2.z;
    p.x = q1.w*q2.x+q1.x*q2.w+q1.y*q2.z-q1.z*q2.z;
    p.y = q1.w*q2.z-q1.x*q2.z+q1.y*q2.w+q1.z*q2.x;
    p.z = q1.w*q2.z+q1.x*q2.z-q1.y*q2.x+q1.z*q2.w;
    return p;
}
template<class T>
