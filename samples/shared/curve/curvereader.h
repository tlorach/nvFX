...
protected:
    ...
    bool*   m_pDirty; // pointer to the 'dirty' flag of the element that own the bindPtr stuff.
public:
    ...
    void bindPtrs(float *v1=NULL, float *v2 = NULL, float *v3 = NULL, float *v4 = NULL, bool *pDirty=NULL);
    void unbindPtrs();
...
public:
    ...
    CurveVector *getCVByIndex(int i) {return ( i < (int)m_curves.size()) ? m_curvesVec[i] : 0; };
